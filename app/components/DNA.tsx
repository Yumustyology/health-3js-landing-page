...
function DNA(props:any) {
  ...
  const { nodes, materials, animations } = useGLTF('/assets/glb/dna_vr_interactive_animation.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} position={[0,0,-4.5]}>
              ...
              <group name="RootNode">
                ...
                <group
                  ...
                  <mesh
                    ...
                    castShadow
                    receiveShadow
                    geometry={(nodes.polySurface56_Base_Material_0 as any).geometry}
                    // material={materials.Base_Material}
                  >
                    <meshPhysicalMaterial transmission={1} metalness={0.5} roughness={0.2}/>
                    </mesh>
                  <mesh
                    name="polySurface56_Fita_Material_0"
                    castShadow
                    receiveShadow
                    geometry={(nodes.polySurface56_Fita_Material_0 as any).geometry}
                    // material={materials.Fita_Material}
                  >
                    <meshPhysicalMaterial transmission={1} metalness={.5} roughness={.2}/>
                  </mesh>
                </group>
                <group
                  name="camera1"
...
useGLTF.preload('/assets/glb/dna_vr_interactive_animation.glb')
